...
public class BaseMdParser implements MdParser {

    //    boolean wasNewline = true;
    protected DocusaurusTextReader reader;
    private MdRow pushBackRow;

    public BaseMdParser(Reader r) {
    ...
    public MdElement readAdmonition() {
        ...
        if (s.length() == 3) {
            ...
            return new MdAdmonition(":::",
                    ...
                    new BaseMdParser(new StringReader(c == null ? "" : c)).parse()
            );
        }
        return null;
    }
